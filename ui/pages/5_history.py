...
with st.sidebar:
    ...
    st.page_link("ui/app.py",                    label="🏠  Home")
    st.page_link("ui/pages/1_dashboard.py",       label="📊  Wells Overview")
    st.page_link("ui/pages/2_upload.py",          label="📁  Upload Dataset")
    st.page_link("ui/pages/3_manual_entry.py",    label="✏️  Manual Entry")
    st.page_link("ui/pages/4_analysis.py",        label="🔬  Analysis Results")
    st.page_link("ui/pages/5_history.py",         label="🕰️  History")
    st.page_link("ui/pages/6_settings.py",        label="⚙️  Settings")
...
if len(history) == 0:
    ...
    with col_a:
        if st.button("📁 Upload Dataset", width='stretch'):
            st.switch_page("ui/pages/2_upload.py")
    with col_b:
        if st.button("✏️ Manual Entry", width='stretch'):
            st.switch_page("ui/pages/3_manual_entry.py")
    st.stop()
